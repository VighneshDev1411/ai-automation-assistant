...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-[9999] min-w-[8rem] overflow-hidden rounded-lg border-2 p-1',
        // Light mode - Solid white with strong shadow and border
        'bg-white border-gray-200 text-gray-900 shadow-2xl',
        // Dark mode - Solid dark with strong border and glow
